...
use FileEye\ImageInfo\core\Block\Index;
 ...
 * Test the Spec class.
 */
class SpecTest extends ImageInfoTestCaseBase
{
    /**
    ...
    public function testDefaultSpec()
    {
        ...
        $this->assertEquals('FileEye\ImageInfo\core\Block\Ifd', $ifd_0->getCollection()->getPropertyValue('class'));
        $this->assertEquals('FileEye\ImageInfo\core\Block\Index', $ifd_canon_camera_settings->getCollection()->getPropertyValue('class'));

        // Test retrieving IFD post-load callbacks.
        $this->assertEquals([
            'FileEye\ImageInfo\core\Block\Ifd::thumbnailToBlock',
            'FileEye\ImageInfo\core\Block\Ifd::makerNoteToBlock',
    ...
    public function testGetEntryClass()
    {
        ...
        $this->assertEquals('FileEye\ImageInfo\core\Entry\ExifUserComment', Collection::get('ifdExif')->getItemCollection(0x9286)->getPropertyValue('entryClass'));
        $this->assertEquals('FileEye\ImageInfo\core\Entry\Time', Collection::get('ifdExif')->getItemCollection(0x9003)->getPropertyValue('entryClass'));
    ...
    {
        $ifd = $this->getMockBuilder('FileEye\ImageInfo\core\Block\Ifd')
                    ->disableOriginalConstructor()
    ...
    public function getTagTextProvider()
    {
        return [
            'IFD0/PlanarConfiguration - value 1' => [
                'Chunky format', 'FileEye\ImageInfo\core\Entry\Core\Short', 'ifd0', 'PlanarConfiguration', [1],
            ],
            'IFD0/PlanarConfiguration - missing mapping' => [
                6.1, 'FileEye\ImageInfo\core\Entry\Core\Short', 'ifd0', 'PlanarConfiguration', [6.1],
            ],
            'CanonPanoramaInformation/PanoramaDirection - value 4' => [
                '2x2 Matrix (Clockwise)', 'FileEye\ImageInfo\core\Entry\Core\SignedShort', 'ifdMakerNotesCanonPanoramaInformation', 'PanoramaDirection', [4],
            ],
            'CanonCameraSettings/LensType - value 493' => [
                'Canon EF 500mm f/4L IS II USM or EF 24-105mm f4L IS USM', 'FileEye\ImageInfo\core\Entry\Core\Short', 'ifdMakerNotesCanonCameraSettings', 'LensType', [493],
            ],
            'CanonCameraSettings/LensType - value 493.1' => [
                'Canon EF 24-105mm f/4L IS USM', 'FileEye\ImageInfo\core\Entry\Core\Short', 'ifdMakerNotesCanonCameraSettings', 'LensType', [493.1],
            ],
            'IFD0/YCbCrSubSampling - value 2, 1' => [
                'YCbCr4:2:2', 'FileEye\ImageInfo\core\Entry\IfdYCbCrSubSampling', 'ifd0', 'YCbCrSubSampling', [2, 1],
            ],
            'IFD0/YCbCrSubSampling - value 2, 2' => [
                'YCbCr4:2:0', 'FileEye\ImageInfo\core\Entry\IfdYCbCrSubSampling', 'ifd0', 'YCbCrSubSampling', [2, 2],
            ],
            'IFD0/YCbCrSubSampling - value 6, 7' => [
                '6, 7', 'FileEye\ImageInfo\core\Entry\IfdYCbCrSubSampling', 'ifd0', 'YCbCrSubSampling', [6, 7],
            ],
            'Exif/SubjectArea - value 6, 7' => [
                '(x,y) = (6,7)', 'FileEye\ImageInfo\core\Entry\ExifSubjectArea', 'ifdExif', 'SubjectArea', [6, 7],
            ],
            'Exif/SubjectArea - value 5, 6, 7' => [
                'Within distance 5 of (x,y) = (6,7)', 'FileEye\ImageInfo\core\Entry\ExifSubjectArea', 'ifdExif', 'SubjectArea', [5, 6, 7],
            ],
            'Exif/SubjectArea - value 4, 5, 6, 7' => [
                'Within rectangle (width 4, height 5) around (x,y) = (6,7)', 'FileEye\ImageInfo\core\Entry\ExifSubjectArea', 'ifdExif', 'SubjectArea', [4, 5, 6, 7],
            ],
            'Exif/SubjectArea - wrong components' => [
                'Unexpected number of components (1, expected 2, 3, or 4).', 'FileEye\ImageInfo\core\Entry\ExifSubjectArea', 'ifdExif', 'SubjectArea', [6],
            ],
            'Exif/FNumber - value 60, 10' => [
                'f/6.0', 'FileEye\ImageInfo\core\Entry\ExifFNumber', 'ifdExif', 'FNumber', [[60, 10]],
            ],
            'Exif/FNumber - value 26, 10' => [
                'f/2.6', 'FileEye\ImageInfo\core\Entry\ExifFNumber', 'ifdExif', 'FNumber', [[26, 10]],
            ],
            'Exif/ApertureValue - value 60, 10' => [
                '8.0', 'FileEye\ImageInfo\core\Entry\ExifApertureValue', 'ifdExif', 'ApertureValue', [[60, 10]],
            ],
            'Exif/ApertureValue - value 26, 10' => [
                '2.5', 'FileEye\ImageInfo\core\Entry\ExifApertureValue', 'ifdExif', 'ApertureValue', [[26, 10]],
            ],
            'Exif/FocalLength - value 60, 10' => [
                '6.0 mm', 'FileEye\ImageInfo\core\Entry\ExifFocalLength', 'ifdExif', 'FocalLength', [[60, 10]],
            ],
            'Exif/FocalLength - value 26, 10' => [
                '2.6 mm', 'FileEye\ImageInfo\core\Entry\ExifFocalLength', 'ifdExif', 'FocalLength', [[26, 10]],
            ],
            'Exif/SubjectDistance - value 60, 10' => [
                '6.0 m', 'FileEye\ImageInfo\core\Entry\ExifSubjectDistance', 'ifdExif', 'SubjectDistance', [[60, 10]],
            ],
            'Exif/SubjectDistance - value 26, 10' => [
                '2.6 m', 'FileEye\ImageInfo\core\Entry\ExifSubjectDistance', 'ifdExif', 'SubjectDistance', [[26, 10]],
            ],
            'Exif/ExposureTime - value 60, 10' => [
                '6 sec.', 'FileEye\ImageInfo\core\Entry\ExifExposureTime', 'ifdExif', 'ExposureTime', [[60, 10]],
            ],
            'Exif/ExposureTime - value 5, 10' => [
                '1/2 sec.', 'FileEye\ImageInfo\core\Entry\ExifExposureTime', 'ifdExif', 'ExposureTime', [[5, 10]],
            ],
            'GPS/GPSLongitude' => [
                '30° 45\' 28" (30.76°)', 'FileEye\ImageInfo\core\Entry\GPSDegrees', 'ifdGps', 'GPSLongitude', [[30, 1], [45, 1], [28, 1]],
            ],
            'GPS/GPSLatitude' => [
                '50° 33\' 12" (50.55°)', 'FileEye\ImageInfo\core\Entry\GPSDegrees', 'ifdGps', 'GPSLatitude', [[50, 1], [33, 1], [12, 1]],
            ],
            'Exif/ShutterSpeedValue - value 5, 10' => [
                '5/10 sec. (APEX: 1)', 'FileEye\ImageInfo\core\Entry\ExifShutterSpeedValue', 'ifdExif', 'ShutterSpeedValue', [[5, 10]],
            ],
            'Exif/BrightnessValue - value 5, 10' => [
                '0.5', 'FileEye\ImageInfo\core\Entry\ExifBrightnessValue', 'ifdExif', 'BrightnessValue', [[5, 10]],
            ],
            'Exif/ExposureBiasValue - value 5, 10' => [
                '+0.5', 'FileEye\ImageInfo\core\Entry\ExifExposureBiasValue', 'ifdExif', 'ExposureBiasValue', [[5, 10]],
            ],
            'Exif/ExposureBiasValue - value -5, 10' => [
                '-0.5', 'FileEye\ImageInfo\core\Entry\ExifExposureBiasValue', 'ifdExif', 'ExposureBiasValue', [[-5, 10]],
            ],
            'Exif/ExifVersion - short' => [
                '2.2', 'FileEye\ImageInfo\core\Entry\Core\Undefined', 'ifdExif', 'ExifVersion', [2.2], true,
            ],
            'Exif/FlashPixVersion - short' => [
                '2.5', 'FileEye\ImageInfo\core\Entry\Core\Undefined', 'ifdExif', 'FlashPixVersion', [2.5], true,
            ],
            'Interoperability/InteroperabilityVersion - short' => [
                '1.0', 'FileEye\ImageInfo\core\Entry\Core\Undefined', 'ifdInteroperability', 'InteroperabilityVersion', [1], true,
            ],
            'Exif/ComponentsConfiguration' => [
                'Y Cb Cr -', 'FileEye\ImageInfo\core\Entry\ExifComponentsConfiguration', 'ifdExif', 'ComponentsConfiguration', ["\x01\x02\x03\0"],
            ],
            'Exif/FileSource' => [
                'DSC', 'FileEye\ImageInfo\core\Entry\ExifFileSource', 'ifdExif', 'FileSource', ["\x03"],
            ],
            'Exif/SceneType' => [
                'Directly photographed', 'FileEye\ImageInfo\core\Entry\ExifSceneType', 'ifdExif', 'SceneType', ["\x01"],
            ],
        ];
    }
    ...
    public function testJpegSegmentTitles()
    {
        ...
        $this->assertEquals(ImageInfo::fmt('Restart %d', 3), $collection->getItemCollection(0xD3)->getPropertyValue('title'));
        $this->assertEquals(ImageInfo::fmt('Application segment %d', 3), $collection->getItemCollection(0xE3)->getPropertyValue('title'));
        $this->assertEquals(ImageInfo::fmt('Extension %d', 11), $collection->getItemCollection(0xFB)->getPropertyValue('title'));
    }
}
