...
class Tags1Test extends ExifEyeTestCaseBase
{
    public function testTags()
    {
        ...
        $ratingPercent = $ifd0->xxGetTagByName('RatingPercent')->xxGetEntry();
