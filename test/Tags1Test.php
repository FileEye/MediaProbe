...
class Tags1Test extends MediaProbeTestCaseBase
{
    public function testTags()
    {
        ...
        $this->assertInstanceOf('FileEye\MediaProbe\Block\Exif', $jpeg->getElement("jpegSegment/exif"));
        ...
        $this->assertInstanceOf('FileEye\MediaProbe\Block\Ifd', $ifd0);
        ...
        $this->assertInstanceOf('FileEye\MediaProbe\Block\Ifd', $exifIfd);
